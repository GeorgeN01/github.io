...
gameBoard.rows[2].cells[0].style.color = "Green";
}
else if(mark.index == 7){
gameBoard.rows[2].cells[1].innerHTML = "O";
gameBoard.rows[2].cells[1].style.color = "Green";
}
else if(mark.index == 8){
gameBoard.rows[2].cells[2].innerHTML = "O";
gameBoard.rows[2].cells[2].style.color = "Green";
}
...
gameBoard.rows[1].cells[0].style.color = "Green";
}
else if(mark.index == 4){
gameBoard.rows[1].cells[1].innerHTML = "O";
gameBoard.rows[1].cells[1].style.color = "Green";
}
else if(mark.index == 5){
gameBoard.rows[1].cells[2].innerHTML = "O";
gameBoard.rows[1].cells[2].style.color = "Green";
}
...
gameBoard.rows[0].cells[0].style.color = "Green";
}
else if(mark.index == 1){
gameBoard.rows[0].cells[1].innerHTML = "O";
gameBoard.rows[0].cells[1].style.color = "Green";
}
else if(mark.index == 2){
gameBoard.rows[0].cells[2].innerHTML = "O";
gameBoard.rows[0].cells[2].style.color = "Green";
}
